...
For my reboot, I'm focusing on learning more React. The biggest shift is moving from Jekyll to [Gatsby](https://www.gatsbyjs.org/), another static site generator built around React. I've also included some sub-challenges: adding more restrained and accessible CSS theming, and something I'll just call the "Reactrix" for now.
