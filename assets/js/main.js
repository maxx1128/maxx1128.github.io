...
var f = {
    colorLighten: function colorLighten(hex, lum) {
...
var css_props = function css_props(color_primary, color_secondary, color_action, color_mono, spacing_base, fontFamily_base, fontFamily_header, fontFamily_mono, settings, overrides) {
    ...
    var properties = {
        ...
        '--color-secondary-lighter': f.colorLighten(color_primary, set.colLighter),
        '--color-secondary-light': f.colorLighten(color_primary, set.colLight),
        '--color-secondary-dark': f.colorLighten(color_primary, set.colDark),
        '--color-secondary-darker': f.colorLighten(color_primary, set.colDarker),
        '--color-action-lighter': f.colorLighten(color_primary, set.colLighter),
        '--color-action-light': f.colorLighten(color_primary, set.colLight),
        '--color-action-dark': f.colorLighten(color_primary, set.colDark),
        '--color-action-darker': f.colorLighten(color_primary, set.colDarker),
        '--color-mono-blank': f.colorLighten(color_primary, set.colLighter),
        '--color-mono-light': f.colorLighten(color_primary, set.colLight),
        '--color-mono-dark': f.colorLighten(color_primary, set.colDark),
        '--color-mono-darkest': f.colorLighten(color_primary, set.colDarker),
...
var themes = {
    'porygon-z': css_props('#1e456e', '#5ab46a', '#ff826e', '#373737', 1, '-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", sans-serif', '"Raleway", Futura, Helvetica, Arial, sans-serif', 'sans-serif', null, { '--color-mono-darkest': '#080401' })
}; // Object of constructed themes here

var updateTheme = function updateTheme(theme) {
    Object.entries(theme).forEach(function (_ref5) {
